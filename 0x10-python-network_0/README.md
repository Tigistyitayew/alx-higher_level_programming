...
-   Your script must send a `POST` request with the contents of a file, passed with the filename
...
Write a Bash script that makes a request to `0.0.0.0:5000/catch_me` that causes the server
